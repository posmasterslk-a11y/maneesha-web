<template>
  <div class="p-6">
    <div class="mb-6 flex justify-between items-center">
      <div>
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Delivery Charges</h1>
        <p class="text-gray-500 dark:text-gray-400 mt-1">Manage delivery fees for all 25 districts in Sri Lanka.</p>
      </div>
